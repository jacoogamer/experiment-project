...
#if UNITY_EDITOR
using Aidar_StreamingAssetsImp = Aidar_StreamingAssets.EditorImpl;
#elif UNITY_ANDROID
using Aidar_StreamingAssetsImp = Aidar_StreamingAssets.ApkImpl;
#else
using Aidar_StreamingAssetsImp = Aidar_StreamingAssets.LooseFilesImpl;
#endif

public static class Aidar_StreamingAssets
{
    ...
    {
		get { return Aidar_StreamingAssetsImp.s_root; }
    }

    public static void Initialize()
    {
		Aidar_StreamingAssetsImp.Initialize(Application.dataPath, Application.streamingAssetsPath);
    }

#if UNITY_EDITOR
    public static void InitializeWithExternalApk(string apkPath)
    {
		Aidar_StreamingAssetsImp.ApkMode = true;
		Aidar_StreamingAssetsImp.Initialize(apkPath, "jar:file://" + apkPath + "!/assets/");
    }

    public static void InitializeWithExternalDirectories(string dataPath, string streamingAssetsPath)
    {
		Aidar_StreamingAssetsImp.ApkMode = false;
		Aidar_StreamingAssetsImp.Initialize(dataPath, streamingAssetsPath);
    }
#endif
    ...
    {
        ReadInfo info;
		return Aidar_StreamingAssetsImp.TryGetInfo(path, out info);
    }

    public static bool DirectoryExists(string path)
    {
		return Aidar_StreamingAssetsImp.DirectoryExists(path);
    }
    ...
    public static System.IO.Stream OpenRead(string path)
    {
		...
		return Aidar_StreamingAssetsImp.OpenRead(path);
    }
	...
	return Aidar_StreamingAssetsImp.ReadAllBytes(path);
    }

    public static string[] GetFiles(string path, string searchPattern, SearchOption searchOption)
    {
	return Aidar_StreamingAssetsImp.GetFiles(path, searchPattern, searchOption);
    }
    ...
    {
        ReadInfo result;
	if ( !Aidar_StreamingAssetsImp.TryGetInfo(path, out result) )
